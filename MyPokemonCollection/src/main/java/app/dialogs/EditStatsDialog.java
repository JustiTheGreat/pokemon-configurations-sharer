...
public class EditStatsDialog extends app.dialogs.Dialog {
    ...
    public EditStatsDialog(ICallbackContext context, int resourceId, Pokemon pokemon) {
    ...
    public void loadDialog() {
        ...
        natureSpinner.setAdapter(new ArrayAdapter<>(((AddPokemon) context).getActivity(),
